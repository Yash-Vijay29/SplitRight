...
from .views import GroupDetailView, GroupDiscoverView, GroupJoinView, GroupListCreateView, GroupMembersView

urlpatterns = [
    path("groups", GroupListCreateView.as_view(), name="groups-list-create"),
    path("groups/discover", GroupDiscoverView.as_view(), name="groups-discover"),
